...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-562-erd-s-problem-562-0f74b15b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-562"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-562-erd-s-problem-562-0f74b15b-v1",
      "problem_contract_sha256": "2397e61c83f568ce9052c37f595bd07ad416b93c5d800ae6415a036461bf4642",
      "problem_id": "problem:um-ep-562-erd-s-problem-562-0f74b15b",
      "route_id": "route:um-ep-562-erd-s-problem-562-0f74b15b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-562-erd-s-problem-562-0f74b15b-source-fidelity-01",
      "graph_id": "graph:um-ep-562-erd-s-problem-562-0f74b15b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-562-erd-s-problem-562-0f74b15b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-562-erd-s-problem-562-0f74b15b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $R_r(n)$ denote the $r$-uniform hypergraph Ramsey number: the minimal $m$ such that if we $2$-colour all edges of the complete $r$-uniform hypergraph on $m$ vertices then there must be some monochromatic copy of the complete $r$-uniform hypergraph on $n$ vertices. Prove that, for $r\\geq 3$, $ \\log_{r-1} R_r(n) \\asymp_r n, $ where $\\log_{r-1}$ denotes the $(r-1)$-fold iterated logarithm. That is, does $R_r(n)$ grow like $ 2^{2^{\\cdots n}} $ where the tower of exponentials has height $r-1$?"
          },
          "statement_sha256": "429182d067188999525638b445636ec0f4e2c5e6f55efb00722567e27a9d22e7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-562-erd-s-problem-562-0f74b15b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-562-erd-s-problem-562-0f74b15b-root",
      "route_id": "route:um-ep-562-erd-s-problem-562-0f74b15b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-562-d86015dfb1e1",
        "url": "https://www.unsolvedmath.com/problems/EP-562"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
